...
class Receiver extends JFrame implements ActionListener, KeyListener {
    JTextArea ta;
    JTextField tf1, tf2;
    JLabel l1, l2, l3;
    JButton b1;
    ...
    public void keyTyped(KeyEvent e) {
     ...
     private void sendMessage() {
	    ...
	    try
		{
			...
			Date date1 = new Date();
	    		SimpleDateFormat ft1 = new SimpleDateFormat ("E dd.MM.yyyy 'at' hh:mm");
    
            		ta.append("Client ["+ft1.format(date1)+"] :\n" + new String(b) + "\n");
           		tf2.setText("");
